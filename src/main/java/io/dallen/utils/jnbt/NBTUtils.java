...
public final class NBTUtils {
     ...
     */
    public static <T extends Tag> T getChildTag(Map<String, Tag> items, String key, Class<T> expected) throws DataFormatException {
        if (!items.containsKey(key)) {
            throw new DataFormatException("Missing a \"" + key + "\" tag");
        }
